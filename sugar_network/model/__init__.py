...
POST_TYPES = [
        ...
        'artefact',     # Object generated by Context application
        'question',     # Q&A request
        'issue',        # Bug with the Context
        'idea',         # An idea fr the Context
        'notice',       # Auto-generated Post for updates within the Context
        'post',         # General purpose dependent Post
        'solution',     # Dependent Post with solution for question|issue|idea
        ]
